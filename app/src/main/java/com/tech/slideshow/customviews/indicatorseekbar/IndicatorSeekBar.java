...
public class IndicatorSeekBar extends View {
    ...
    private int mScale = 1;//the transition_scale of the float progress.
    ...
    //indicator
    private Indicator mIndicator;//the pop transition_window above the seek bar
    ...
    /**
     * The specified transition_scale for the progress value,
     * make sure you had chosen the float progress type
     * <p>
     * such as:
     * transition_scale = 3; progress: 1.78627347 to 1.786
     * transition_scale = 4; progress: 1.78627347 to 1.7863
     * <p>
     * make sure you have call the attr progress_value_float=true before, otherwise no change.
     *
     * @param scale transition_scale for the float type progress value.
     */
